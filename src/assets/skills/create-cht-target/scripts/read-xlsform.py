#!/usr/bin/env python3
"""
Read XLSForm files and extract structure for CHT configuration.
...
def analyze_xlsform(filepath):
    """Analyze XLSForm and extract relevant information for CHT configuration."""
    ...
    # Important field patterns for CHT configuration
    important_patterns = [
...
def format_output(analysis):
    ...
    print("=== Important Fields (for targets/tasks/conditions) ===")
    ...
    print("=== Date Fields (for scheduling/filtering) ===")
    ...
    print("=== Select Fields (for target/task conditions) ===")
...
def main():
    if len(sys.argv) < 2:
        ...
        print("useful for CHT target and task configuration.")
        sys.exit(1)
